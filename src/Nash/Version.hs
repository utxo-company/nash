...
compiler :: Version
compiler =
    case map fromIntegral (Version.versionBranch Paths_nash.version) of
        major : minor : patch : _ ->
        ...
        [major] ->
            Version major 0 0
        [] ->
            error "could not detect version of nash-compiler you are using"
