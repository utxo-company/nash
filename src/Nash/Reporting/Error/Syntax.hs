...
module Nash.Reporting.Error.Syntax where
...
import Nash.Parse.Symbol (BadOperator (..))
import Nash.Reporting.Annotation qualified as A
import Nash.Reporting.Doc qualified as D
import Nash.Reporting.Render.Code qualified as Code
import Nash.Reporting.Report qualified as Report
